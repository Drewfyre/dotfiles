...
vim.keymap.set("n", "<leader>E", ":e ~/.config/nvim/init.lua<CR>", { desc = "Edit Neovim config" })
...
vim.keymap.set("n", "<leader>sv", ":split<cr>", { desc = "Split below" })
vim.keymap.set("n", "<leader>ss", ":vsp<cr>", { desc = "Split right" })
